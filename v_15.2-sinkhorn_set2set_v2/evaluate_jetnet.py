...
from v_15_2 import (          # <-- rename `jet_pipeline` to your file's module name
...
MODEL_REGISTRY = {
    "v_15_2": {
        "build_encoder": _cheb_encoder(10),   # K=10, matches v_15.2 training config
        "weights_dir":   "/pscratch/sd/r/rushil13/gsoc_rushil/v_15.2-sinkhorn_set2set_v2/results_v_15.2/weights",
        "note":          "v15.2 from-scratch, STE-pT, ±2 bounds",
    },
}
